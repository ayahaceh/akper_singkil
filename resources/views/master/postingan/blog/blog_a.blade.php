        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('postingan.blog.store') }}" method="post" enctype="multipart/form-data"
                        class="mt-2">
                        @csrf
                        ...
                        <div class="mb-1">
                            ...
                            <div class="form-floating mb-0">
                                <textarea data-length="150" class="form-control char-textarea" name="konten_resume" id="konten_resume" rows="3"
                                    placeholder="Konten Resume" style=" height: 100px" required>{{ old('konten_resume') }}</textarea>
                            </div>
                            <small class="textarea-counter-value float-end">
                                <span class="char-count">
                                    {{ strlen(old('konten_resume', 0)) }}
                                </span> / 150
                            </small>

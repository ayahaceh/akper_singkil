...
@section('container')
    <div class="row d-flex justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('user.tim.update', ['id' => $user->id]) }}" method="post"
                        ...
                        <x-select-comp label="Jenis Pegawai" name="jenis_pegawai" theme="horizontal" col="9"
                            ...
                            @foreach ($ref_jenis_tims as $data)
                                <option value="{{ $data->id }}" @if (old('jenis_pegawai', $user->ref_jenis_tim_id) == $data->id) selected @endif>
                                    {{ $data->nama_jenis }}
                                </option>
                            @endforeach
                        </x-select-comp>

                        <x-input-comp label="Nama" type="text" name="nama" value="{{ $user->nama }}" required
                            theme="horizontal" />

                        <x-input-comp label="NIP" type="number" name="nip" value="{{ $user->nip }}"
                            theme="horizontal" />

                        {{-- <x-input-comp label="Selaku" type="text" name="selaku" value="{{ $user->selaku }}" required
                            theme="horizontal" /> --}}

                        <x-textarea-comp label="Tentang" name="tentang" rows="3" value="{{ $user->tentang }}"
                            theme="horizontal" />
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="text" name="twitter" id="twitter"
                                            value="{{ old('twitter', $user->twitter) }}" class="form-control"
                                            placeholder="Twitter" />
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="text" name="facebook" id="facebook"
                                            value="{{ old('facebook', $user->facebook) }}" class="form-control"
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="text" name="instagram" id="instagram"
                                            value="{{ old('instagram', $user->instagram) }}" class="form-control"
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="text" name="linkedin" id="linkedin"
                                            value="{{ old('linkedin', $user->linkedin) }}" class="form-control"
                        ...
                        <x-input-comp label="No. Urut" type="number" name="no_urut" value="{{ $user->no_urut }}" required
                            theme="horizontal" />
                            ...
                            <div class="border rounded p-2">
                                ...
                                <div class="d-flex flex-column flex-md-row">
                                    <img src="{{ $user->foto_profil_compress }}" id="profil-feature-image"
                                        class="me-2 mb-1 mb-md-0" style="border-radius: 100%;" width="50"
                                        height="50" alt="Profil" />
